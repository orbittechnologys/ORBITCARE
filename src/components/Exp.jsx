  ...
  return (
    <>
      <div>
        ...
        <aside
          id="default-sidebar"
          className={`fixed top-0 left-0 z-40 w-64 overflow-y-auto h-screen transition- ${
            toggle ? "" : "-translate-x-full sm:translate-x-0"
          } `}
          aria-label="Sidebar"
        >
          <div className=" px-3 py-8  bg-[#ffffff] dark:bg-green-800">
            <a className="flex items-center ps-2.5 mb-5 sticky top-0 bg-white py-2">
            ...
            <ul className="space-y-4 font-medium">
              ...
              <li>
                <button
                  className="flex items-center w-full hover:text-green-500 justify-between px-4 text-gray-600 rounded-lg dark:text-white hover:bg-gray-100 "
              ...
              <li>
                <a href="#" className="flex justify-between  gap-5 mt-12 items-start">
                  <span className="flex flex-wrap lg:flex-nowrap text-gray-500 px-4 mb-4 text-sm  font-sans">
                    Traffic this Month
                  </span>
              ...
              <li>
                <a href="#" className="flex justify-between gap-5 mt-12 items-start">
                  <span className="flex flex-wrap lg:flex-nowrap text-gray-500 px-4 text-sm mb-4 font-sans">
                    Server Load
                  </span>
